...
public class UniUpdateShellCommand extends OsgiCommandSupport{
    ...
    protected Object doExecute() throws Exception {
        ...
        final NodeId uniNodeId = new NodeId(UnimgrUtils.createUniNodeId(uniAug.getIpAddress()));
        final InstanceIdentifier<Node> uniNodeIid = UnimgrMapper.getUniNodeIid(uniNodeId);
        final InstanceIdentifier<Node> ovsdbNodeIid = null;
        if (provider.updateUni(uniNodeIid, uniAug, ovsdbNodeIid)) {
