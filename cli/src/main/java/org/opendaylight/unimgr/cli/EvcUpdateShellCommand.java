...
public class EvcUpdateShellCommand extends OsgiCommandSupport {
    ...
    @Option(name = "-evcLinkId", aliases = {
            "--EVC-Link-Id" }, description = "EVC LinkID.", required = true, multiValued = false)
    private String evcLinkID = "";
    ...
    protected Object doExecute() throws Exception {
        ...
        LinkId id = new LinkId(evcLinkID);
        InstanceIdentifier<Link> evckey = UnimgrMapper.getEvcLinkIid(id);
