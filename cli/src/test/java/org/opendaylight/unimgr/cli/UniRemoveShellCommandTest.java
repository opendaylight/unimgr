...
public class UniRemoveShellCommandTest {
    ...
    private final IUnimgrConsoleProvider provider = new IUnimgrConsoleProvider() {
        ...
        @Override
        public UniAugmentation getUni(IpAddress ipAddress) {return null;}
        @Override
        public Evc getEvc(String uuid) {return null;}
        @Override
        public boolean addUni(UniAugmentation uni) {return false;}
        @Override
