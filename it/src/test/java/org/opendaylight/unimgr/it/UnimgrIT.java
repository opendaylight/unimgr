...
public class UnimgrIT extends AbstractMdsalTestBase {
    ...
    public void testCreateUni() {
        ...
        InstanceIdentifier<Node> uniNodeIid = createUniNode(MAC_ADDRESS_1, IP_1);
        Assert.assertNotNull(uniNodeIid);
        InstanceIdentifier<Node> iid = getUniIid("uni://" + IP_1);
        boolean status = validateUni(true, iid);
