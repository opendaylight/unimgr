...
public class UnimgrCreateIT extends AbstractMdsalTestBase {
    ...
    public void testAddUni() {
        ...
        UniAugmentation uni = new UniAugmentationBuilder()
                ...
                .build();
        boolean result = provider.addUni(uni);
        Assert.assertTrue("Add UNI was successful", result);
        Assert.assertFalse("Add UNI was not successful", provider.addUni(null));
    }
