...
public class UnimgrDeleteIT extends AbstractMdsalTestBase {
    ...
    protected void initDatastore(final DataBroker dataBroker, final LogicalDatastoreType type, TopologyId topoId) {
    ...
    public Option getLoggingOption() {
        Option option = editConfigurationFilePut(ORG_OPS4J_PAX_LOGGING_CFG,
                logConfiguration(UnimgrDeleteIT.class),
                LogLevel.INFO.name());
    ...
    public static boolean deleteNode(DataBroker dataBroker, UniAugmentation uni) {
        NodeId uniNodeId = new NodeId(createUniNodeId(uni.getIpAddress()));
