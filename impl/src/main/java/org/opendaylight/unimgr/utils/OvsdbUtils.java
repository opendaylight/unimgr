...
public class OvsdbUtils {
    ...
    public static void createOvsdbNode(DataBroker dataBroker,
        ...
        try {
            ...
            LOG.error("Exception while creating OvsdbNodeAugmentation, Uni is null. Node Id: {}, {}", ovsdbNodeId, e.getMessage());
        }
    }
    ...
    private static void updateQosMaxRate(DataBroker dataBroker,
        ...
        try {
            ...
            LOG.warn("Failed to put {}, {}", qosOtherConfigIid, e.getMessage());
        }
    }
    ...
    public static IpAddress getLocalIp() {
        ...
        try {
            ...
            LOG.info("Unable to retrieve controller's ip address, using loopback. {}", e.getMessage());
        }
