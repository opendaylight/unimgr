...
public class MdsalUtils {
    ...
    public static final Optional<Node> readNode(DataBroker dataBroker,
        ...
        try {
            ...
            LOG.error("Unable to read node with Iid {} , {}", nodeIid, e.getMessage());
        }
    ...
    public static boolean deleteNode(DataBroker dataBroker,
        ...
        try {
            ...
            LOG.error("Unable to remove node with Iid {} from store {}, {}.", genericNode, store, e.getMessage());
        }
        return result;
    }
    ...
    public static final Optional<Link> readLink(DataBroker dataBroker,
        ...
        try {
            ...
            LOG.info("Unable to read node with Iid {}, {}", linkIid, e.getMessage());
        }
        return Optional.absent();
    }
    ...
    public static final Optional<Node> readNode(DataBroker dataBroker,
        ...
        try {
            ...
            LOG.info("Unable to read node with Iid {}, {}", nodeIid, e.getMessage());
        }
        return Optional.absent();
    }
}
