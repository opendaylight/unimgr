...
public class UnimgrUtils {
    ...
    private static List<QosEntries> createQosEnteries(Uni uni, Long queueNumber) {
        ...
        QosEntriesKey key = new QosEntriesKey(new Uri(SouthboundConstants.QOS_LINUX_HTB + uni.getMacLayer()));
        ...
        QueueList queueList = new QueueListBuilder()
                ...
                .setQueueUuid(new Uuid(UUID.randomUUID().toString()))
                .build();
        ...
        QosEntries qosEntry = new QosEntriesBuilder()
                .setKey(key)
                .setQosId(new Uri(uni.getMacLayer()))
    ...
    private static List<Queues> createQueues(Uni uni, Long queueNumber) {
        ...
        Queues queues = new QueuesBuilder()
                ...
                .setKey(new QueuesKey(new Uri(queueNumber.toString() + uni.getMacLayer())))
                .setQueueId(new Uri(queueNumber.toString() + uni.getMacLayer()))
