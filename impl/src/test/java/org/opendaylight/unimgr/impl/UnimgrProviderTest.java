...
@PrepareForTest({UnimgrProvider.class, InstanceIdentifier.class, LogicalDatastoreType.class, FrameworkUtil.class})
public class UnimgrProviderTest {
    ...
    public void testInitializeTopology() throws Exception {
        ...
        verify(ntb).build();
        verify(transaction).put(any(LogicalDatastoreType.class), any(InstanceIdentifier.class), any(NetworkTopology.class));
    ...
    public void testInitDatastore() throws Exception {
        ...
        when(transaction.read(any(LogicalDatastoreType.class), any(InstanceIdentifier.class))).thenReturn(unimgrTp);
