 ...
 */
package org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.driver;
...
import org.opendaylight.unimgr.mef.nrp.cisco.xr.common.util.PseudowireUtil;
import org.opendaylight.unimgr.mef.nrp.cisco.xr.common.util.SipHandler;
import org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.activator.AbstractL2vpnActivator;
import org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.activator.AbstractL2vpnBridgeDomainActivator;
import org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.activator.L2vpnBridgeDomainActivator;
import org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.activator.L2vpnBridgeDomainLocalActivator;
import org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.activator.L2vpnLocalConnectActivator;
import org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.activator.L2vpnP2pConnectActivator;
...
public class XrDriverBuilder implements ActivationDriverBuilder {
    ...
    public static final String XR_NODE = "xr-node-6.1";
    ...
    protected ActivationDriver getDriver() {
        final ActivationDriver driver = new ActivationDriver() {
            ...
            public void activate()  {
            	PseudowireHelper.setPseudowireId(PseudowireUtil.generatePseudowireId());
                if (serviceType != null
                        && (serviceType.getName().equals(ServiceType.MULTIPOINTCONNECTIVITY.getName())
                                || serviceType.getName().equals(
                                        ServiceType.ROOTEDMULTIPOINTCONNECTIVITY.getName()))) {
