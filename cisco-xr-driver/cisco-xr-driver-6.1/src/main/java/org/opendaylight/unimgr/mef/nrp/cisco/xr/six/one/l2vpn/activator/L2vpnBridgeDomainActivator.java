...
import org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.common.helper.BandwidthProfileHelper;
import org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.helper.BridgeDomainAttachmentCircuitHelper;
import org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.helper.BridgeDomainHelper;
import org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.helper.BridgeDomainPseudowireHelper;
...
public class L2vpnBridgeDomainActivator extends AbstractL2vpnBridgeDomainActivator {
    ...
    protected Optional<PolicyManager> activateQos(String name, ServicePort port) {
        return null;
        /*new BandwidthProfileHelper(port).addPolicyMap(name, INGRESS, UNI)
