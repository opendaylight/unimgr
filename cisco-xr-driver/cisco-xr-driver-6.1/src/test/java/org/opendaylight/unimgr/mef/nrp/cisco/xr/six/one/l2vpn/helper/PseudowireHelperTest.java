 ...
 */
package org.opendaylight.unimgr.mef.nrp.cisco.xr.six.one.l2vpn.helper;
...
public class PseudowireHelperTest {
    ...
    public void testBuild() {
        //given
        final Uint32 pseudowireId = Uint32.valueOf(PseudowireUtil.generatePseudowireId());
        PseudowireHelper.setPseudowireId(pseudowireId.longValue());
