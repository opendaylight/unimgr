...
public class L2vpnHelperTest {
	...
	/*
	 * @Test public void build() { //given XconnectGroups xconnectGroups =
	 * Mockito.mock(XconnectGroups.class);
	 * 
	 * //when L2vpn actual = L2vpnHelper.build(xconnectGroups);
	 * 
	 * //then Database actualDatabase = actual.getDatabase();
