...
public class InterfaceRev170907Helper {

   private static final Logger LOG = LoggerFactory.getLogger(InterfaceRev170907Helper.class);
   ...
   public static Stream<InterfaceConfiguration> ports(ReadTransaction tx) throws InterruptedException, ExecutionException {
    ...
    private static void setL2Configuration(InterfaceConfigurationBuilder configurationBuilder) {
      ...
      configurationBuilder.addAugmentation(InterfaceConfiguration4.class,
      augmentation);
    }
    public static InstanceIdentifier<P2pXconnect> getXConnectIds(String innerName,String outerName)
    {
    	InstanceIdentifier<P2pXconnect> xconnectId = deactivate(innerName, outerName);
    	return xconnectId;
    }
    private static InstanceIdentifier<P2pXconnect> deactivate(String innerName, String outerName) {
