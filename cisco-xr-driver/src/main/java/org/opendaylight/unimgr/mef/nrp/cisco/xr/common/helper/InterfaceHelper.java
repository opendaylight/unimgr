...
public class InterfaceHelper {
    ...
    public static Map<String, String> getNodeInterfaceIdentifierList() {
        return nodeInterfaceIdentifierList;
    }
                ...
                if (mountPoint.isPresent()) {
                      ...
                      try {
                            if(InterfaceRev150730Helper.ports(tx).count() > 0) {
                                nodeInterfaceIdentifierList.put(key.getNodeId().getValue(), InterfaceRev150730Helper.getInterfaceConfigurationsId().getTargetType().getPackageName());
                      ...
                      try {
						 if (InterfaceRev170907Helper.ports(tx).count() > 0) { 
							 nodeInterfaceIdentifierList.put(key.getNodeId().getValue(), InterfaceRev170907Helper.getInterfaceConfigurationsId().getTargetType().getPackageName());
