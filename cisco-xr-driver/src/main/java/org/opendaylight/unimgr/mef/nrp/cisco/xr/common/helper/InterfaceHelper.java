...
public class InterfaceHelper {
    ...
    public InterfaceHelper configure(FcPort port, Optional<Mtus> mtus, boolean setL2Transport) {
        return configure(getInterfaceName(port), mtus, setL2Transport);
    }

    public InterfaceHelper configure(InterfaceName name, Optional<Mtus> mtus, boolean setL2Transport) {
