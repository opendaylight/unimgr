...
public class XConnectHelper {
    ...
    public static XconnectGroups createXconnectGroups(XconnectGroup xconnectGroup) {
        ...
        xconnectGroups.add(xconnectGroup);

        return createXconnectGroups(xconnectGroups);
    }
    ...
    public XConnectHelper configure(String name, AttachmentCircuits attachmentCircuits, Pseudowires pseudowires) {
