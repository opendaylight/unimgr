...
*/
    ...
    @Override
    protected void doDeactivate(ServicePort port, String serviceId,
        ...
        new TransactionActivator().deactivateBridgeDomain(
                                            port,                                        
	...
	/*
	 * protected void doDeactivateNew(ServicePort port,
	 * InstanceIdentifier<org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.
	 * ios.xr.l2vpn.cfg.rev170626.bridge.domain.table.bridge.domains.BridgeDomain>
	 * bridgeDomainId, InstanceIdentifier<InterfaceConfiguration>
	 * interfaceConfigurationId, boolean isExclusive, EndPoint endPoint,
	 * List<String> dvls2, List<Uuid> inls2) throws InterruptedException,
	 * ExecutionException {
	 * 
	 * new TransactionActivator().deactivate(port, bridgeDomainId,
	 * interfaceConfigurationId, isExclusive, endPoint, mountService, dvls2, inls2);
	 * }
	 */
    
    /*protected void doDeactivateNew(ServicePort port, InstanceIdentifier<org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.l2vpn.cfg.rev170626.bridge.domain.table.bridge.domains.BridgeDomain> bridgeDomainId,
            InstanceIdentifier<InterfaceConfiguration> interfaceConfigurationId,
            boolean isExclusive, EndPoint endPoint, List<String> dvls2, List<Uuid> inls2)
                    throws InterruptedException, ExecutionException {
