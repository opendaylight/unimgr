...
public class XConnectHelperTest {
    ...
    @Test
    public void testCreateXconnectGroupsMultiplee() {
        //given
    ...
    @Test
    public void testConfigureP2pXconnect() {
        //given
        XConnectHelper xConnectHelper = new XConnectHelper();
        ...
        //when
        xConnectHelper.configure(xConnectName, attachmentCircuits, pseudowires);
        P2pXconnects p2pXconnects = xConnectHelper.getP2pXconnects();
        XconnectGroup xconnectGroup = xConnectHelper.getXconnectGroup(xConnectGroupName);
