...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr._6._1.l2vpn.cfg.rev151109.l2vpn.database.bridge.domain.groups.bridge.domain.group.bridge.domains.bridge.domain.bd.attachment.circuits.BdAttachmentCircuit;
...
public class L2vpnBridgeDomainActivatorTest {
	...
	public void setUp() throws Exception {
		...
		ConnectivityServiceEndPoint cep1 = new org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.connectivity.rev180307.connectivity.service.EndPointBuilder()
				.setServiceInterfacePoint(TapiUtils.toSipRef(new Uuid(UUID2), ServiceInterfacePoint.class))
				.setDirection(PortDirection.BIDIRECTIONAL).build();
	...
	public void activateBridgeDomainTest() {
		...
		/*BridgeDomainGroups dominGroups = l2vpnBridgeDomainActivator.activateBridgeDomain(outerName, innerName, port,
				neighbor, bdPseudowires, isExclusive);
		...
		List<BdAttachmentCircuit> bdAttachmentCircuitList = bdAttachmentCircuits.getBdAttachmentCircuit();
	...
	public void activateInterfaceTest() { 
       /*
		InterfaceConfigurations interfaceConfigruaton = l2vpnBridgeDomainActivator.activateInterface(port, neighbor,
				2000, false);
	...
	public void createSubInterfaceTest() {
		port.setVlanId(301L);
		/*
		InterfaceConfigurations interfaceConfiguration = l2vpnBridgeDomainActivator.createSubInterface(port, neighbor,
				2000);
