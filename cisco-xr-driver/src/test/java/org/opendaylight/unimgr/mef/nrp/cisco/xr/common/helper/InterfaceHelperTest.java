...
public class InterfaceHelperTest {
    ...
    @Test
    public void testConfigureSingle() {
        //given
        ...
        //when
        interfaceHelper.configure(interfaceName, mtus, setL2Transport);
        InterfaceConfigurations actual = interfaceHelper.getInterfaceConfigurations();
    ...
    @Test
    public void testConfigureSingleMtuL2() {
        //given
        String interfaceNameValue = "GigabitEthernet0/0/1";
    ...
    @Test
    public void testConfigureMultiple() {
        //given
        ...
        //when
        interfaceHelper.configure(interfaceName1, mtus, setL2Transport);
        interfaceHelper.configure(interfaceName2, mtus, setL2Transport);
        InterfaceConfigurations actual = interfaceHelper.getInterfaceConfigurations();
