...
public class OvsActivatorTest extends AbstractDataBrokerTest{
    ...
    public void testActivate() {
        ...
        //when
        try {
            ovsActivator.activate(endPoints, serviceId, true, ServiceType.POINTTOPOINTCONNECTIVITY.getName());
        ...
        //when
        try {
            ovsActivator.deactivate(endPoints, serviceId, ServiceType.POINTTOPOINTCONNECTIVITY.getName());
        } catch (TransactionCommitFailedException e) {
            fail(e.getMessage());
        } catch (ResourceNotAvailableException e) {
            fail(e.getMessage());
