...
public class NetvirtVpnUtils {
    ...
    public static void refreshDpnGw(/*OdlL3vpnListener odlL3vpnListener,*/ final NotificationPublishService notificationPublishService, String vpnName, BigInteger dpId) {
