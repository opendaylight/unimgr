...
import org.opendaylight.yang.gen.v1.http.metroethernetforum.org.ns.yang.mef.interfaces.rev150526.mef.interfaces.SubnetsKey;
...
import org.opendaylight.yang.gen.v1.http.metroethernetforum.org.ns.yang.mef.interfaces.rev150526.mef.interfaces.subnets.ip.uni.SubnetKey;
...
public final class MefInterfaceUtils {
    ...
    public static InstanceIdentifier<Subnet> getSubnetInstanceIdentifier(Identifier45 identifier45,
            Identifier45 identifier452, IpPrefix subnet) {
        return InstanceIdentifier.builder(MefInterfaces.class).child(Subnets.class, new SubnetsKey(identifier45))
                .child(org.opendaylight.yang.gen.v1.http.metroethernetforum.org.ns.yang.mef.interfaces.rev150526.mef.interfaces.subnets.IpUni.class,
                        new org.opendaylight.yang.gen.v1.http.metroethernetforum.org.ns.yang.mef.interfaces.rev150526.mef.interfaces.subnets.IpUniKey(
                                identifier452))
                .child(Subnet.class, new SubnetKey(subnet)).build();
    }
