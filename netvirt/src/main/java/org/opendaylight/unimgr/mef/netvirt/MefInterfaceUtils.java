...
public final class MefInterfaceUtils {
    ...
    public static InstanceIdentifier<Subnet> getSubnetsListInstanceIdentifier() {
...
/*    
    public static InstanceIdentifier<Subnet> getSubnetInstanceIdentifier(Identifier45 uniId, Identifier45 ipUniId,
            IpPrefix subnet) {
        return InstanceIdentifier.builder(MefInterfaces.class).child(Subnets.class)
                .child(org.opendaylight.yang.gen.v1.http.metroethernetforum.org.ns.yang.mef.interfaces.rev150526.mef.interfaces.subnets.Uni.class,
                        new org.opendaylight.yang.gen.v1.http.metroethernetforum.org.ns.yang.mef.interfaces.rev150526.mef.interfaces.subnets.UniKey(
                                uniId))
                .child(org.opendaylight.yang.gen.v1.http.metroethernetforum.org.ns.yang.mef.interfaces.rev150526.mef.interfaces.subnets.uni.IpUni.class,
                        new org.opendaylight.yang.gen.v1.http.metroethernetforum.org.ns.yang.mef.interfaces.rev150526.mef.interfaces.subnets.uni.IpUniKey(
                                ipUniId))
