...
public class NetvirtUtils {
    ...
    public static void updateElanInstance(DataBroker dataBroker, String instanceName) {
        ...
        MDSALUtil.syncUpdate(dataBroker, LogicalDatastoreType.CONFIGURATION, getElanInstanceInstanceIdentifier(instanceName), einstBuilder.build());
    }
    ...
    public static void updateElanInterface(DataBroker dataBroker, String instanceName, String interfaceName) {
        ...
        MDSALUtil.syncUpdate(dataBroker, LogicalDatastoreType.CONFIGURATION, getElanInterfaceInstanceIdentifier(interfaceName),
                einterfaceBuilder.build());
    }
    ...
    public static void deleteElanInstance(DataBroker dataBroker, String instanceName) {
        ...
        MDSALUtil.syncDelete(dataBroker, LogicalDatastoreType.CONFIGURATION, getElanInstanceInstanceIdentifier(instanceName));
    }
    ...
    public static void deleteElanInterface(DataBroker dataBroker, String instanceName, String interfaceName) {
        ...
        MDSALUtil.syncDelete(dataBroker, LogicalDatastoreType.CONFIGURATION, getElanInterfaceInstanceIdentifier(interfaceName));
    }
    ...
    private static InstanceIdentifier getUniInterfaceInstanceIdentifier(String interfaceName) {
        return InstanceIdentifier.builder(MefInterfaces.class).child(Unis.class).child(Uni.class, new UniKey(new Identifier45(interfaceName)))
                .build();
    }
}
